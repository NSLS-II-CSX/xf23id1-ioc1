...
/* Generated from ../O.Common/cn7500.dbd */
...
epicsShareExtern void (*pvar_func_snccn7500Registrar)(void);
epicsShareExtern void (*pvar_func_tempCompareRegistrar)(void);
...
{
    const char *bldTop = "/epics/iocs/va-bakeout-02";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"cn7500_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    cn7500_registerRecordDeviceDriver(*iocshPpdbbase);
}
