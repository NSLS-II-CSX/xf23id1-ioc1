...
pmacAsynIPConfigure("P0","xf23id1-mc09:1025")
...
pmacCreateController("motor","P0",0,5,100,1000)
...
dbLoadRecords("$(EPICS_BASE)/db/asynComm.db","P=XF:23ID1-CT{MC:09},PORT=P0,ADDR=0")
dbLoadRecords("$(EPICS_BASE)/db/pmacStatus.db","SYS=XF:23ID1-CT,PMAC=MC:09,VERSION=1,PLC=5,PORT=P0,NAXES=8")

dbLoadRecords("$(EPICS_BASE)/db/iocAdminSoft.db","IOC=XF:23ID1-CT{IOC:MC09}")
...
dbl > "/cf-update/xf23id1-ioc1.mc09.dbl"
