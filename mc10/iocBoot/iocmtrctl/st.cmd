...
pmacAsynIPConfigure("P0","xf23id1-mc10:1025")
...
dbLoadRecords("db/asynComm.db","P=XF:23ID1-CT{MC:10},PORT=P0,ADDR=0")
dbLoadTemplate("db/motorstatus.substitutions")
dbLoadRecords("db/pmacStatus.db","SYS=XF:23ID1-CT,PMAC=MC:10,VERSION=1,PLC=5,PORT=P0,NAXES=8")
dbLoadTemplate("db/pmac_asyn_motor.substitutions")
dbLoadTemplate("db/motorPosSel.substitutions")
dbLoadRecords("$(EPICS_BASE)/db/iocAdminSoft.db","IOC=XF:23ID1-CT{IOC:MC10}")
...
dbl > "/cf-update/xf23id1-ioc1.mc10.dbl"
