...
pmacAsynIPConfigure("P0","xf23id1-mc06:1025")
...
dbLoadRecords("db/asynComm.db","P=XF:23ID1-CT{MC:06},PORT=P0,ADDR=0")

dbLoadRecords("$(EPICS_BASE)/db/iocAdminSoft.db", "IOC=XF:23ID1-CT{IOC:MC06}")
...
dbl > "/cf-update/xf23id1-ioc1.mc06.dbl"
