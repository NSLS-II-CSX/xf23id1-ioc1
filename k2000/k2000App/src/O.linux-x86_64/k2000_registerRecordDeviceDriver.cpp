...
/* Generated from ../O.Common/k2000.dbd */
...
int k2000_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/k2000";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"k2000_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    k2000_registerRecordDeviceDriver(*iocshPpdbbase);
}
