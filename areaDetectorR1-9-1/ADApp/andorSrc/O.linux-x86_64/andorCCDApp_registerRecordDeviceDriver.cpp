...
/* Generated from ../O.Common/andorCCDApp.dbd */
...
epicsShareExtern void (*pvar_func_andorCCDRegister)(void);
...
int andorCCDApp_registerRecordDeviceDriver(DBBASE *pbase)
{
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"andorCCDApp_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    andorCCDApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
