...
/* Generated from ../O.Common/prosilicaApp.dbd */
...
int prosilicaApp_registerRecordDeviceDriver(DBBASE *pbase)
{
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"prosilicaApp_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    prosilicaApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
