...
/* Generated from ../O.Common/PSLApp.dbd */
...
epicsShareExtern void (*pvar_func_PSLRegister)(void);
...
int PSLApp_registerRecordDeviceDriver(DBBASE *pbase)
{
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"PSLApp_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    PSLApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
