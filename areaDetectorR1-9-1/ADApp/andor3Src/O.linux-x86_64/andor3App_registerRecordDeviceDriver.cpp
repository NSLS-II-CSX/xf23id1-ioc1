...
/* Generated from ../O.Common/andor3App.dbd */
...
epicsShareExtern void (*pvar_func_andor3Register)(void);
...
int andor3App_registerRecordDeviceDriver(DBBASE *pbase)
{
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"andor3App_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    andor3App_registerRecordDeviceDriver(*iocshPpdbbase);
}
