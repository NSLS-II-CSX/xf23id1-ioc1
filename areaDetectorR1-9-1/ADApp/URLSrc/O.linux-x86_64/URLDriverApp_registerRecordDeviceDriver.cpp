...
/* Generated from ../O.Common/URLDriverApp.dbd */
...
epicsShareExtern void (*pvar_func_URLDriverRegister)(void);
...
int URLDriverApp_registerRecordDeviceDriver(DBBASE *pbase)
{
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"URLDriverApp_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    URLDriverApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
