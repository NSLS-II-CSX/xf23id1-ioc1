...
/* Generated from ../O.Common/BISDetectorApp.dbd */
...
epicsShareExtern void (*pvar_func_BISDetectorRegister)(void);
...
int BISDetectorApp_registerRecordDeviceDriver(DBBASE *pbase)
{
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"BISDetectorApp_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    BISDetectorApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
