...
/* Generated from ../O.Common/pilatusDetectorApp.dbd */
...
static const char * const deviceSupportNames[90] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[90] = {
...
epicsShareExtern void (*pvar_func_pilatusDetectorRegister)(void);
...
int pilatusDetectorApp_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    (*pvar_func_pilatusDetectorRegister)();
    (*pvar_func_asSub)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"pilatusDetectorApp_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    pilatusDetectorApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
