##!/epics/iocs/areaDetectorR1-9-1/bin/linux-x86/prosilicaApp

epicsEnvSet("PREFIX", "LTB-BI{VF:1}")
epicsEnvSet("AREA_DETECTOR","/epics/iocs/areaDetectorR1-9-1")
epicsEnvSet("TOP","/epics/iocs/areaDetectorR1-9-1")
...
epicsEnvSet("MCA","/usr/lib/epics")
epicsEnvSet("AUTOSAVE","/usr/lib/epics")
#epicsEnvSet("TRSCAN", "Passive")
...
prosilicaConfig("$(PORT)", 10.0.134.1, 50, 0)
...
dbLoadRecords("$(AREA_DETECTOR)/ADApp/Db/prosilica.template","P=$(PREFIX),R=cam1:,PORT=$(PORT),ADDR=0,TIMEOUT=1, TRSCAN=Passive")
