...
pmacCreateController("motor","P0",0,7,100,1000)
...
pmacAsynCoordCreate("P0",0,4,4,10)
...
pmacSetCoordStepsPerUnit(4,6,1.0)
pmacSetCoordStepsPerUnit(4,7,1.0)

# change poll rates (card, poll-period in ms)
pmacSetCoordMovingPollPeriod(2,200)
pmacSetCoordIdlePollPeriod(2,1000)
pmacSetCoordMovingPollPeriod(3,200)
pmacSetCoordIdlePollPeriod(3,1000)
...
dbLoadRecords("db/asynComm.db","P=XF:23ID1-CT{MC:03},PORT=P0,ADDR=0")
dbLoadTemplate("db/motorstatus.substitutions")
dbLoadRecords("db/pmacStatus.db","SYS=XF:23ID1-CT,PMAC=MC:03,VERSION=1,PLC=5,PORT=P0,NAXES=8")
dbLoadTemplate("db/pmac_asyn_motor.substitutions")
dbLoadRecords("db/iocAdminSoft.db","IOC=XF:23ID1-CT{IOC:MC03}")
...
dbl > "/cf-update/xf23id1-ioc1.mc03.dbl"
