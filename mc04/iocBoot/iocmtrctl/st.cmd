...
pmacAsynIPConfigure("P0","xf23id1-mc04:1025")
...
dbLoadRecords("db/asynComm.db","P=XF:23ID1-CT{MC:04},PORT=P0,ADDR=0")

dbLoadRecords("$(EPICS_BASE)/db/iocAdminSoft.db", "IOC=XF:23ID1-CT{IOC:MC04}")
...
dbl > "/cf-update/xf23id1-ioc1.mc04.dbl"
